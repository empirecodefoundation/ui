...
import TemplateCodeViewer from "@/components/template-code-viewer";
...
const dashboardCodeExample = `"use client";
...
import { Avatar, AvatarImage, AvatarFallback } from "@/components/ui/avatar";
import { Progress } from "@/components/ui/progress";
import { Activity, BarChart, MessageSquare } from "lucide-react";
...
export default function AIDashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-950">
      {/* Sidebar */}
      <aside className="bg-gray-900 w-64 text-white">
        <div className="p-4 border-b border-gray-800">
          <h1 className="text-xl font-bold">Empire AI</h1>
        </div>
        <nav className="p-4">
          <ul className="space-y-2">
            <li>
              <a href="#" className="flex items-center p-2 rounded-lg bg-gray-800">
      ...
      <div className="bg-gray-950 p-8 border-t border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-2xl font-bold text-white">Dashboard Template Code</h2>
              <p className="text-gray-400">Use this code as a starting point for your own AI dashboard.</p>
            </div>
            <Button 
              variant="outline" 
