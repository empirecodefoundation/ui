...
<Tabs defaultValue="npm" className="mt-6 mb-10">
  ...
  <TabsContent value="npm" className="mt-2">
    <CodeBlock language="bash" code="npm install @empireui/components" showCopyButton />
  </TabsContent>
  <TabsContent value="yarn" className="mt-2">
    <CodeBlock language="bash" code="yarn add @empireui/components" showCopyButton />
  </TabsContent>
  <TabsContent value="pnpm" className="mt-2">
    <CodeBlock language="bash" code="pnpm add @empireui/components" showCopyButton />
  </TabsContent>
</Tabs>
...
<CodeBlock language="bash" code="npx empireui@latest init" showCopyButton />
...
<CodeBlock language="js" showCopyButton code={`/** @type {import('tailwindcss').Config} */
module.exports = {
  darkMode: ["class"],
  content: [
    './pages/**/*.{ts,tsx}',
...
<CodeBlock language="jsx" showCopyButton code={`// Basic usage
...
<CodeBlock language="plaintext" showCopyButton code={`# OpenAI API key for AI components
...
<CodeBlock language="bash" showCopyButton code="npm install framer-motion react-dom tailwindcss tailwindcss-animate" />
