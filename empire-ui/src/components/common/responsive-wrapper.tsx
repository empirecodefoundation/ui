...
export const ResponsiveWrapper = ({ children }: ResponsiveWrapperProps) => {
  return (
    <>
      {/* Mobile/Small Screen Message - Hidden on screens >= 1280px */}
      <div className="block xl:hidden min-h-screen bg-black flex flex-col items-center justify-center p-8 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className={cn("text-gray-300 text-lg mb-8", MinecartLCD.className)}>
            This website is optimized for desktop experience. Please access it from a device with at least 1280px screen width for the best experience.
          </p>
      ...
      <div className="hidden xl:block">
        <div 
          ...
          "
          style={{
            // Fallback for browsers that don't support CSS custom properties in scale
