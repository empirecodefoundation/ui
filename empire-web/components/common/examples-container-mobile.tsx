  ...
  return (
    <div className="flex flex-col my-4 justify-center items-center px-4 pb-12 sm:hidden">
      ...
      <div className="cta-section flex flex-col sm:flex-row items-center justify-center mt-12 space-y-4 sm:space-y-0 sm:space-x-4">
        <a
          href="/docs"
          className="bg-[#fd8a46] hover:bg-[#fd7a2e] text-black font-bold py-3 px-8 w-full text-center sm:w-auto rounded-sm transition-colors text-lg"
        >
        ...
        <a
          ...
          className="bg-transparent border-2 border-[#f3edd8] text-[#f3edd8] font-bold py-3 px-8 w-full text-center sm:w-auto rounded-sm hover:bg-[#f3edd81a] transition-colors text-lg"
        >
          View on GitHub
        </a>
      </div>
